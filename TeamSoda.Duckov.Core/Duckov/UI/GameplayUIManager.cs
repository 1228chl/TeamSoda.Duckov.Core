...
namespace Duckov.UI
{
	...
	public class GameplayUIManager : MonoBehaviour
	{
		...
		public static T GetViewInstance<T>() where T : View
		{
			...
			View view;
			if (GameplayUIManager.Instance.viewDic.TryGetValue(typeof(!!0), out view))
			{
				return view as !!0;
			}
			View view2 = GameplayUIManager.Instance.views.Find((View e) => e is !0);
			if (view2 == null)
			{
				return default(!!0);
			}
			GameplayUIManager.Instance.viewDic[typeof(!!0)] = view2;
			return view2 as !!0;
		}
